...
```
```{r}
armaorig = arima(dt, order = c(5, 1, 5), seasonal = list(order = c(0, 1, 0), period = 12))
L = 36

armaorig

preds = predict(armaorig, n.ahead = L)
plot(c(dt, preds$pred), type = "l", xlab = "Time", ylab = "Data", main = 'ARMA(5,5)')
points((n+1):(n+L), data_test, type = "l")
points((n+1):(n+L), preds$pred, type = "l", col = "blue")
```
```{r}
armaorig = arima(dt, order = c(0, 1, 1), seasonal = list(order = c(0, 1, 0), period = 12))
L = 36

armaorig

preds = predict(armaorig, n.ahead = L)
plot(c(dt, preds$pred), type = "l", xlab = "Time", ylab = "Data", main = 'MA(1)')
points((n+1):(n+L), data_test, type = "l")
points((n+1):(n+L), preds$pred, type = "l", col = "blue")
```

```{r}
armaorig = arima(dt, order = c(5, 1, 5), seasonal = list(order = c(2, 1, 1), period = 12))
L = 36

armaorig

preds = predict(armaorig, n.ahead = L)
plot(c(dt, preds$pred), type = "l", xlab = "Time", ylab = "Data", main = 'ARMA(5,5) X (2,1)_12')
points((n+1):(n+L), data_test, type = "l")
points((n+1):(n+L), preds$pred, type = "l", col = "blue")
```

```{r}
armaorig = arima(dt, order = c(5, 1, 5), seasonal = list(order = c(1, 1, 1), period = 12))
L = 36

armaorig

preds = predict(armaorig, n.ahead = L)
plot(c(dt, preds$pred), type = "l", xlab = "Time", ylab = "Data", main = 'ARMA(5,5) X (1,1)_12')
points((n+1):(n+L), data_test, type = "l")
points((n+1):(n+L), preds$pred, type = "l", col = "blue")
```
